...
namespace DataAccessLayer.Context
{
    public class TourStopContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CheckPoint>().Property(x => x.Address).IsRequired();
            modelBuilder.Entity<CheckPoint>().Property(x => x.StartTime).IsRequired();
            modelBuilder.Entity<CheckPoint>().Property(x => x.Tour).IsRequired();
            #endregion

            #region MessageConfig
            modelBuilder.Entity<Message>().Property(x => x.Content).IsRequired();
            modelBuilder.Entity<Message>().Property(x => x.Sender).IsRequired();
            ...
            modelBuilder.Entity<MessageHasReciever>().Property(x => x.Message).IsRequired();
            modelBuilder.Entity<MessageHasReciever>().Property(x => x.Reciever).IsRequired();
            #endregion

            #region MovementCondig
            modelBuilder.Entity<Movement>().Property(x => x.Reservation).IsRequired();
            modelBuilder.Entity<Movement>().Property(x => x.MovementsType).IsRequired();
            modelBuilder.Entity<Movement>().Property(x => x.Tour).IsRequired();
            #endregion

            #region OrderConfig
            modelBuilder.Entity<Order>().Property(x => x.User).IsRequired();
            ...
            modelBuilder.Entity<PaymentInfo>().Property(x => x.User).IsRequired();
            //PENDING
            #endregion
            ...
            #region RatingConfig
            modelBuilder.Entity<Rating>().Property(x => x.User).IsRequired();
            modelBuilder.Entity<Rating>().Property(x => x.Tour).IsRequired();
            modelBuilder.Entity<Rating>().Property(x => x.RatingValue).IsRequired();
            #endregion

            #region ReservationConfig
            modelBuilder.Entity<Reservation>().Property(x => x.User).IsRequired();
            modelBuilder.Entity<Reservation>().Property(x => x.Tour).IsRequired();
            modelBuilder.Entity<Reservation>().Property(x => x.Order).IsRequired();
            ...
            #region TourConfig
            modelBuilder.Entity<Tour>().Property(x => x.User).IsRequired();
