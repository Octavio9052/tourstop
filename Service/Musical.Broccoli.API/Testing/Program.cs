...
namespace Testing
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            User user1 = getNewUser("1",UserType.Promotor);
            User user2 = getNewUser("2",UserType.User);
            users.Add(user1);
            users.Add(user2);
            userRepo.Add(users);
        ...
        private static User getNewUser(string id, UserType usertype)
        {
            return new User
            {
                Address = new Address
                ...
                FirstName = String.Format("TestName{0}", id),
                LastName = String.Format("LastName{0}", id),
                Email =String.Format( "test_unitesting{0}@test.com",id),
                Phone = "64617850353",
                Password = "123456",
